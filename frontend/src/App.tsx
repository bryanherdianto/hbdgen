...
function App() {
  ...
  const isImmersive = location.pathname.startsWith("/pages/") || location.pathname.startsWith("/templates/");

  return (
    <div className="app-container min-h-screen flex flex-col">
      {!isImmersive && (<header className="sticky top-0 z-50 p-4 glassy">
      ...
      <main className={isImmersive ? "flex-grow w-full h-full" : "flex-grow container mx-auto py-8 px-4"}>
        <Routes>
          ...
          <Route path="/templates/simple-valentine" element={<SimpleValentine />} />
          <Route
            path="/sign-in/*"
            element={
      ...
      {!isImmersive && (<footer className="bg-black text-white py-10">
        <div className="container mx-auto px-4 text-center">
          <p className="font-medium">
            © {new Date().getFullYear()} Wishly
          </p>
