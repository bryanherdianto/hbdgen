...
function SimpleValentine() {
    ...
    const handleNoClick = () => {
        ...
        setCurrentImg(prev => prev === '/heart-love.gif' ? '/cry-cute.gif' : '/heart-love.gif');
    };

    if (isAccepted) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-rose-50 font-pacifico gap-8 p-4 text-center">
                <h1 className="text-4xl md:text-6xl text-rose-600 mb-5">Yey, thank you! ❤️</h1>
                <div className="text-rose-500 font-lato font-semibold text-lg md:text-xl">
                    {message}
                </div>
                <img src="/kitty-heart.gif" alt="Happy Kitty" className="w-64 md:w-80" />
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-rose-50 font-pacifico gap-8 p-4 text-center">
            <h1 className="text-4xl md:text-6xl text-rose-600">Will you be my Valentine?</h1>
