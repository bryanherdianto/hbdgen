...
const BirthdayCake: React.FC = () => {
    ...
    return (
        <div className="relative w-[250px] h-[200px] mt-[-50px] mb-[80px] ml-[-125px] top-1/2 left-1/2">
            ...
            {/* Layers */}
            <div className="absolute w-[250px] h-[100px] rounded-[50%] bg-[#553c13] top-[66px]" style={{ boxShadow: chocolateShadow }}></div>
            <div className="absolute w-[250px] h-[100px] rounded-[50%] bg-[#553c13] top-[33px]" style={{ boxShadow: chocolateShadow }}></div>
            <div className="absolute w-[250px] h-[100px] rounded-[50%] bg-[#553c13] top-0" style={{ boxShadow: chocolateShadow }}></div>
